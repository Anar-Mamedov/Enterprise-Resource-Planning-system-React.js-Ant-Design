...
const Index = () => {
  ...
  const columns = [
    {
      title: <Sorter title="Təşkilatın adı" onClick={() => Sort(0)} />,
      dataIndex: "name_nat",
      key: "name_nat",
      ellipsis: false,
      width: 170,
    ...
    {
      title: <Sorter title="Kod" onClick={() => Sort(1)} />,
      dataIndex: "code",
      key: "code",
      ellipsis: false,
      width: 170,
    ...
    {
      title: <Sorter title="Vöen" onClick={() => Sort(2)} />,
      dataIndex: "voen",
      key: "voen",
      ellipsis: false,
      width: 170,
    ...
    {
      title: <Sorter title="MÜƏSSİSƏ TİPİ" onClick={() => Sort(3)} />,
      dataIndex: "registr_type",
      key: "registr_type",
      ellipsis: false,
      width: 170,
      align: "center",
  ...
  const renderTableView = () => {
    ...
    API.Finance.Companies.Organization.index(JSON.stringify(showdata.current)).then((res) => {
      setLoading(true);
  ...
  const changeStatus = (status) => {
    if (selectedRowKeys.length) {
      ...
      API.Finance.Companies.Organization.activity(params).then((res) => {
        if (res.status === 200) {
