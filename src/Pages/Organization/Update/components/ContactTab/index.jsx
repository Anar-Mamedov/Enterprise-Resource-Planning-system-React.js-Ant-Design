...
const Index = ({ bankTime, taxEdv, banks, setItem, form, loading, setLoading, details, setDetails, contactType, setContactType }) => {
  //*Piclist Start   ---------------------------------------------------------------------------------------
            ...
            <Row key={index}>
              <Col span={24}>
                <Row gutter={14}>
                  {index === 0 ? (
                    <Col span={5}>
                      {/* <Form.Item hidden name={["contact", index, "uuid"]} /> */}
                  ...
                  <Col span={5}>
                    <Form.Item hidden name={["contact", "contact_type", index, "uuid"]} />
                  ...
                  <Col
                    ...
                    <Button
                      ...
                      icon={<MinusOutlined />}
                      onClick={() => {
                        setDetails((state) => state.filter((_, idx) => idx !== index));

                        const newContactType = contactType;
                        delete newContactType[index];
