...
import MakingDepositBank from './MakingDepositBank'
import PaymentCustomer from './PaymentCustomer'
import DebtLoanPayments from './DebtLoanPayments'
import PurchaseForeignCurrencies from './PurchaseForeignCurrencies'
import IncomeProductReturns from './IncomeProductReturns'
import { PlusOutlined } from '@ant-design/icons'
import { Button, Input, Row, Col, Form, Select, Space, Radio, Divider, DatePicker, Cascader } from 'antd'
  ...
  return (
    <Row gutter={5}>
      ...
      <Col span={5} >
        <Row>
          <Col span={24}>
            <FormItem label='Qəbul edən' bottom={0}
      ...
      <Col span={5} >
        <FormItem label='Sənədin tarixi' name='document_date'
          rules={[{ required: true, message: 'Zəhmət olmazsa seçim edin' }]}
        >
          <DatePicker
...
Index.MakingDepositBank = () => <MakingDepositBank />
Index.PaymentCustomer = () => <PaymentCustomer />
Index.DebtLoanPayments = () => <DebtLoanPayments />
Index.PurchaseForeignCurrencies = () => <PurchaseForeignCurrencies />
Index.IncomeProductReturns = () => <IncomeProductReturns />
