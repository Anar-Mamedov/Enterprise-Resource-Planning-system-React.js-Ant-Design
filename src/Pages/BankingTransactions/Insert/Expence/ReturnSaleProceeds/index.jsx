...
const Index = () => {
  return (
    <Row>
      <Col span={24}>
        <Divider className={style.title} orientation="left">Satışdan gələn gəlirin geri qaytarılması</Divider>
      </Col>
      <Col span={24}>
        <Row gutter={5}>
          ...
          <Col span={6} >
            <FormItem label='Geri qaytarılma sənədi' name='' rules={[{ required: true, message: 'Zəhmət olmazsa seçim edin' }]}>
              <Select allowClear={true} showSearch={true} optionFilterProp="children" placeholder="Zəhmət olmazsa seçim edin">
                <Option value="1">1</Option>
              </Select>
            </FormItem>
